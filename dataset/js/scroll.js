			...
			if (settings.vertical)
			{
				...
				refreshV = function()
				{
					...
					vscrollbar.stop(true)[(settings.animate && init) ? 'animate' : 'css']({
						...
						left: '6px', //(element.innerWidth()-(settings.usePadding ? element.parseCSSValue('padding-right')+settings.padding.right : settings.padding.right)-settings.width+scrollH)+'px',
