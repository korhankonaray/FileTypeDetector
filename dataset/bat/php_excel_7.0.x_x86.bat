...
CD %DIR%\phpdev\vc14\x86\php-7.0.17\ext

@ECHO.
@ECHO cloning php_excel repository...
git clone https://github.com/johmue/php_excel.git
CD %DIR%\phpdev\vc14\x86\php-7.0.17\ext\php_excel
...
7za x %DIR%\downloads\libxl-win-3.6.5.zip -o%DIR%\phpdev\vc14\x86\php-7.0.17\ext\php_excel -y
CD %DIR%\phpdev\vc14\x86\php-7.0.17\ext\php_excel
