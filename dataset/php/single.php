													...
													<li>
														<div class="bordered">
															<figure class="add-border">
																<img src="<?php echo ThemeMakersHelper::resize_image($source_url, 570, true, 380) ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
															</figure>
														</div><!--/ .bordered-->			
														<?php
														break;
				...
				default:
					...
					<?php if (has_post_thumbnail()): ?>
						...
						<div class="bordered">
							<figure class="add-border">
								<?php
								$img_width = ($_REQUEST['sidebar_position'] == 'no_sidebar' ? 940 : 570);
								?>
