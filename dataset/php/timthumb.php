...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', '../../cache/timthumb_cache');// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('DEFAULT_Q') )				define ('DEFAULT_Q', 95);									// Default image quality. Allows overrid in timthumb-config.php
