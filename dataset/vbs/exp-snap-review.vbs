...
CALL changelog_update("01/25/2018", "Cases with multiple applications pending will be indicated with an asterisks (*) by the client name in the spreadsheet.", "Casey Love, Hennepin County")
