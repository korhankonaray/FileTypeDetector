...
Public Class EditingForm_Column_Connections
    ...
    Private Sub UIConnectionsEditorForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        tpl = New Auxiliary.DGVCBSelectors.Templates(form, dc)
        ...
        dgv2.Columns(4).HeaderText += " (" & form.FlowsheetOptions.SelectedUnitSystem.molarflow & ")"
        ...
        For Each str As StreamInformation In dc.MaterialStreams.Values
            If str.StreamBehavior = StreamInformation.Behavior.Sidedraw Then
                ...
                If st Is Nothing Then st = (From st2 As Stage In dc.Stages Select st2 Where st2.Name = str.AssociatedStage).FirstOrDefault
                If st Is Nothing Then st = dc.Stages(0)
                Me.dgv2.Rows.Add(New Object() {dgv2.Rows.Count + 1, st.Name, ReturnObjTag(str.StreamID), str.StreamPhase.ToString, cv.ConvertFromSI(form.FlowsheetOptions.SelectedUnitSystem.molarflow, str.FlowRate.Value), str.ID})
        ...
        Select Case dc.ColumnType
            Case Column.ColType.DistillationColumn
                Select Case dc.CondenserType
                    Case Column.condtype.Full_Reflux
                        Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCCondenserVaporProduct"), "", ""})
                    Case Column.condtype.Partial_Condenser
                        Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCCondenser"), "", ""})
                        Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCCondenserVaporProduct"), "", ""})
                    Case Column.condtype.Total_Condenser
                        Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCCondenser"), "", ""})
                End Select
                Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCReboiler"), "", ""})
            Case Column.ColType.AbsorptionColumn
                Dim id As String = Guid.NewGuid.ToString
                Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCOvrhdProd"), "", ""})
                Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCBotProd"), "", ""})
            Case Column.ColType.ReboiledAbsorber
                Dim id As String = Guid.NewGuid.ToString
                Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCOvrhdProd"), "", ""})
                Me.dgv3.Rows.Add(New Object() {form.GetTranslatedString("DCReboiler"), "", ""})
        ...
        Select Case dc.ColumnType
            Case Column.ColType.DistillationColumn
                If dgv4.Rows.Count = 0 Then
                    ...
                    Me.dgv4.Rows.Add(New Object() {form.GetTranslatedString("DCCondenser"), "", id})
                    Me.dgv4.Rows(Me.dgv4.Rows.Count - 1).Cells(0).ReadOnly = True
                    id = Guid.NewGuid.ToString
                    ...
                    Me.dgv4.Rows.Add(New Object() {form.GetTranslatedString("DCReboiler"), "", id})
                    Me.dgv4.Rows(Me.dgv4.Rows.Count - 1).Cells(0).ReadOnly = True
                End If
            Case Column.ColType.ReboiledAbsorber
                If dgv4.Rows.Count = 0 Then
                ...
                Case 2
                    If value <> "" Then
                        If Not id = "" Then
                            ...
                            End Try
                        End If
                        Dim obj = form.GetFlowsheetSimulationObject(value).GraphicObject
                        Dim sid = obj.Name
                        ...
                        If Not id = "" Then
                            Try
                                ...
                                If form.SimulationObjects.ContainsKey(sid) Then
                                    Dim idx As Integer = form.SimulationObjects(sid).GraphicObject.OutputConnectors(0).AttachedConnector.AttachedToConnectorIndex
                                    'dc.GraphicObject.InputConnectors(idx).AttachedConnector = Nothing
                                    'dc.GraphicObject.InputConnectors(idx).IsAttached = False
    ...
    Function ReturnObjTag(ByVal Id As String) As String
        ...
        If form.SimulationObjects.ContainsKey(Id) Then
            Return form.SimulationObjects(Id).GraphicObject.Tag
        Else
            Return ""
        End If
