...
Public Class EditingForm_SolidsSep
    ...
    Public Property SimObject As UnitOperations.SolidsSeparator
    ...
    Sub UpdateInfo()
        ...
        With SimObject
            ...
            TrackBar1.Value = .LiquidSeparationEfficiency
            TrackBar2.Value = .SeparationEfficiency

            lblRatio1.Text = .LiquidSeparationEfficiency.ToString("N0")
            lblRatio2.Text = .SeparationEfficiency.ToString("N0")
    ...
    Private Sub TrackBar1_Scroll(sender As Object, e As EventArgs) Handles TrackBar1.Scroll
        If Loaded Then SimObject.LiquidSeparationEfficiency = TrackBar1.Value
        lblRatio1.Text = TrackBar1.Value.ToString("N0")
    End Sub

    Private Sub TrackBar2_Scroll(sender As Object, e As EventArgs) Handles TrackBar2.Scroll
        If Loaded Then SimObject.SeparationEfficiency = TrackBar2.Value
        lblRatio2.Text = TrackBar2.Value.ToString("N0")
    End Sub
