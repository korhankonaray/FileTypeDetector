...
Param(
    ...
    [string] $ResourceGroupName = 'Az-Kubernetes-VM-Cluster',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageAccountResourceGroupName, 
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = '..\Templates\VM-Cluster\MainDeploy2.json',
    [string] $TemplateParametersFile = '..\Templates\VM-Cluster\azuredeploy.parameters2.json',
